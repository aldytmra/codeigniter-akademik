                    ...
                    <div class="col-12">
                        <div class="p-20">
                            ...
                            <?php 
                                ...
                                echo form_hidden('id_kurikulum', $user['id_kurikulum']);
                                
                            ?>
                                <div class="form-group row">
                                    <label class="col-2 col-form-label">Tahun Akademik</label>
                                    <div class="col-6">
                                        <?php echo form_input('nama_kurikulum', set_value('nama_kurikulum', $user['nama_kurikulum']), 'class="form-control" placeholder="Masukkan Kode Ruang Lengkap Anda"'); ?>
                                    </div>
                                </div>
